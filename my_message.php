...
<body>
  <!-- Container starts -->
             ...
             <div id="content-timeline">
             	<div id="msg">
                    ...
                    if(isset($_GET['inbox'])) { ?>
                        <table width="70">
                            <tr>
                                <th style='padding-right: 50px;'>Sender:</th>
                                <th style='padding-right: 50px;'>Subject</th>
                                <th style='padding-right: 50px;'>Date</th>
                                <th style='padding-right: 50px;'>Reply</th>
                            </tr>
                            <?php
    ...
    <tr align="center">
        <td>
            <a href="user_profile.php?u_id=<?php echo $msg_sender; ?>" style='padding-right: 50px;text-decoration: none;' target="_blank;"><?php echo $sender_name; ?></a>
        </td>
        <td>
            <a href="my_message.php?inbox&msg_id=<?php echo $msg_id; ?>" style='padding-right: 50px;text-decoration: none;'><?php echo $msg_sub; ?></a>
        </td>
        <td style='padding-right: 50px;text-decoration: none;'><?php echo $msg_date; ?></td>
        <td>
           <a href="my_message.php?inbox&msg_id=<?php echo $msg_id; ?>" style='padding-right: 50px;text-decoration: none;'>Reply</a>
        </td>        
    </tr>             
    <?php } ?> </table>   
    <?php
...
// updating the unread message to read
        ...
        <p><b>My Reply:</b> $reply_content</p>
           ...
           <textarea cols='30' rows='5' name='reply'>
           </textarea><br/>
    ...
    if(isset($_POST['msg_reply']))
        ...
        {
            echo "<h2 align='center'>This is message was already replied!</h2>";
            exit();
        }
        else
        {
