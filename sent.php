<table width="700">
	...
	<tr align="center">
		<td>
			<a href="user_profile.php?u_id=<?php echo $msg_receiver; ?>" target="_blank"><?php echo $receiver_name; ?></a>
		</td>
		<td>
			<a href="my_message.php?sent&msg_id=<?php echo $msg_id;?>"><?php echo $msg_sub; ?></a>
		</td>
		<td>
			<?php echo $msg_date; ?>
		</td>
		<td>
		<a href="my_message.php?sent&msg_id=<?php echo $msg_id; ?>">View Reply</a>			
		</td>
