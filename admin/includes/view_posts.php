...
<h2 style="padding: 5px">Update the Post</h2>
 <form action="" method="post" id="f" class="ff" enctype="multipart/form-data">
 				...
 				<input type="text" style="margin-bottom: 10px; padding: 10px;" name="title" size="80" value="<?php echo $post_title; ?>"/><br> 
 			
 				<textarea cols="69" style="margin-bottom: 10px; padding: 10px;" rows="4" name="content"><?php echo $post_content; ?> </textarea><br>
...
<?php
 ...
 if(isset($_GET['delete'])){
 	...
 	$delete_comments="delete from comments where post_id='$delete_id'";
 	$run_del=mysqli_query($con,$delete_comments);
